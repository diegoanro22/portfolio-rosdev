// components/GooeyNav/GooeyNav.tsx
...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  // 3) Cuando hago click en un <li>, cambio el estado interno (solo si no hay `controlledActiveIndex`)
  ...
  useEffect(() => {
    ...
    const activeLi = allLi[activeIndex] as HTMLElement;
    if (activeLi) {
